...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class HOBI_Customize_Alpha_Color_Control extends Skyrocket_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', get_template_directory_uri() . '/assets/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', get_template_directory_uri() . '/assets/css/customizer-controls.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class HOBI_Alpha_Color_Control extends Skyrocket_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_style( 'skyrocket-custom-controls-css',  get_template_directory_uri() . '/assets/css/customizer-controls.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', get_template_directory_uri() . '/assets/js//wp-color-picker-alpha-min.js', array( 'wp-color-picker' ), '1.0', true );
